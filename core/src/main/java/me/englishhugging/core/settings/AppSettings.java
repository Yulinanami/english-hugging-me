...
public final class AppSettings {
    ...
    public void setVocabularyFileName(String vocabularyFileName) { this.vocabularyFileName = vocabularyFileName; }
    ...
    public void setOverlayMode(OverlayMode overlayMode) { this.overlayMode = overlayMode; }
    ...
    public void setIntervalSeconds(int intervalSeconds) { this.intervalSeconds = Math.max(2, intervalSeconds); }

    public int getNextWordIndex() { return nextWordIndex; }
    public void setNextWordIndex(int nextWordIndex) { this.nextWordIndex = Math.max(0, nextWordIndex); }

    public String getShuffleOrder() { return shuffleOrder; }
    public void setShuffleOrder(String shuffleOrder) { this.shuffleOrder = shuffleOrder == null ? "" : shuffleOrder.trim(); }

    public int getShufflePosition() { return shufflePosition; }
    public void setShufflePosition(int shufflePosition) { this.shufflePosition = Math.max(0, shufflePosition); }

    public int getRandomPlayedCount() { return randomPlayedCount; }
    public void setRandomPlayedCount(int randomPlayedCount) { this.randomPlayedCount = Math.max(0, randomPlayedCount); }
    ...
    public void setOpacity(double opacity) {
        this.opacity = opacity < 0.2 ? 0.2 : Math.min(opacity, 1.0);
    }

    public String getWordColor() { return wordColor; }
    public void setWordColor(String wordColor) { this.wordColor = validColorOrCurrent(wordColor, this.wordColor); }

    public String getTypeColor() { return typeColor; }
    public void setTypeColor(String typeColor) { this.typeColor = validColorOrCurrent(typeColor, this.typeColor); }

    public String getTranslationColor() { return translationColor; }
    public void setTranslationColor(String translationColor) { this.translationColor = validColorOrCurrent(translationColor, this.translationColor); }

    public String getPhraseColor() { return phraseColor; }
    public void setPhraseColor(String phraseColor) { this.phraseColor = validColorOrCurrent(phraseColor, this.phraseColor); }

    public int getWordFontSize() { return wordFontSize; }
    public void setWordFontSize(int wordFontSize) { this.wordFontSize = clamp(wordFontSize, 16, 72); }
    ...
    private static String validColorOrCurrent(String value, String current) {
        ...
        return trimmed.matches("#[0-9a-fA-F]{6}") ? trimmed.toUpperCase() : current;
    }
