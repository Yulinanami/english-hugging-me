...
public final class OverlayService extends Service {
    ...
    private TextView createOverlayView() {
        ...
        textView.setPadding(28, 18, 28, 18);
        textView.setAlpha((float) settings.getOpacity());

        GradientDrawable background = new GradientDrawable();
        background.setColor(Color.argb(166, 0, 0, 0));
        background.setCornerRadius(28);
        textView.setBackground(background);
        textView.setOnTouchListener(this::onOverlayTouch);
        return textView;
    }
    ...
    private boolean onOverlayTouch(View view, MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                settings.setX(layoutParams.x);
                settings.setY(layoutParams.y);
